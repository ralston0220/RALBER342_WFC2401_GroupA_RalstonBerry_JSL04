...
let preferredType = userPreference === 'Sugar-free' ? 'Sugar-free' : 'Regular';

console.log(`The user prefers ${preferredType} variety.`);
...
let restockMessage = cansLeft < 5 ? "Time to restock!" : "We're stocked!";
...
let timeKeeper = currentHour >= 7 && currentHour < 24 ? "Unleash the beast!" : "Better stick to water.";
